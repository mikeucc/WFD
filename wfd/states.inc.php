...
$machinestates = array(
   ...
   'description' => clienttranslate('Other players must choose one Move'),
   'descriptionmyturn' => clienttranslate('${you} must choose one Move card'),
   'args' => 'argDraftPicks',
   ...
   'action' => 'st_MultiPlayerInit'
	...
	4 => array(
	   "description" => clienttranslate('Update Stats'),
        ...
        "updateGameProgression" => true,
        "transitions" => array( "draftCard" => 3, "FinalScore"=>90)
    ),
